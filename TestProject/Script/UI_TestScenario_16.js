...
//
        ...
        Sys.Browser("chrome").Page("https://ocrtest-1673629386.ap-northeast-1.elb.amazonaws.com/").Form("form").Panel(4).Textbox("txtUserName").SetText(userId);
        Sys.Browser("chrome").Page("https://ocrtest-1673629386.ap-northeast-1.elb.amazonaws.com/").Form("form").Panel(4).SubmitButton("btnLogin").ClickButton();
